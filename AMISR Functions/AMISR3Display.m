function AMISR3Display(XX,YY,ZZ,XR,YR,ZR,INTERPVAR,RADARDATA,INDEXPLOT,LONCUT,LATCUT,...
...
hold on
set(ax(1), 'Position',get(ax(1),'Position') -[0.065 -0.058 0 0.02]);
...
hold on
set(ax(3), 'Position', get(ax(3),'Position')-[0.065 0.068 0.0 0.02]);
...
view(AZ,EL)
pos=get(ax(2),'pos');
set(ax(2), 'Position', pos-[0.055 (pos(2)-0.3) 0 -0.085]);
ylabel('North [Km]','FONTSIZE',FONTSIZE)
xlabel('Km East [Km]','FONTSIZE',FONTSIZE)
...
set(hc, 'Position', [.91 0.06 .0581/3 .9],'FONTSIZE',FONTSIZE)
