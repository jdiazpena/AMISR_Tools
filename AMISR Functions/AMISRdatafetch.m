function data=AMISRdatafetch(fileNameStr,type)
...
MLT=h5read(fileNameStr,'/Time/MagneticLocalTimeSite');
data.mlt=MLT(1,:)';

if sum(type=='lp')==2 || sum(type=='ac')==2
...
data.type=type;
data.radar=h5read(fileNameStr,'/Site/Code');
